...
\documentclass[
    ...
    StudentName     = 张志心,
    StudentID       = 3210106357,
    AdvisorName     = 王灿,
    Grade           = 2021,            % only the year, no '级'
    Major           = 计算机科学与技术,
    Department      = 计算机科学与技术学院,
    SubmitDate      = 2025年5月30日,
    MajorFormat     = cs,
    ...
    % Title
    Title           = 基于对抗性偏好优化的语言模型对齐任务算法研究,
    TitleEng        = {{Adversarial Preference Optimization for Data-efficient Alignment of Language Models}}
]{zjuthesis}
